    ...
    <>
          ...
          <div className="cookie-banner relative bg-[#0a0f1a] border border-[#1a2540] w-full max-w-md rounded-lg shadow-2xl overflow-hidden">
            ...
            <div className="px-6 pb-4 text-center">
              <p className="text-[11px] text-[#8899bb] leading-relaxed">
                Usamos cookies para mejorar tu experiencia de compra, analizar el trafico y personalizar el contenido.
              </p>
            </div>
          ...
          <div className="cookie-preferences relative w-full max-w-md bg-[#0a0f1a] border border-[#1a2540] rounded-lg shadow-2xl max-h-[85vh] overflow-hidden flex flex-col">
            ...
            <div className="flex items-center justify-between p-4 border-b border-[#1a2540]">
              <div className="flex items-center gap-3">
                ...
                />
                <h2 className="text-sm font-semibold text-[#e9eef8]">Preferencias De Cookies</h2>
              </div>
              <button
                onClick={() => setShowPreferences(false)}
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
              <p className="text-[11px] text-[#8899bb] mb-4">
                Elige que cookies quieres permitir.
              </p>
              ...
              <CookieCategoryCard
                title="Analiticas"
                description="Nos ayudan a entender como los visitantes interactuan con nuestro sitio."
              ...
              <CookieCategoryCard
                title="Funcionales"
                description="Activan funciones personalizadas como recordar preferencias."
              ...
              <CookieCategoryCard
                title="Marketing"
                description="Se usan para mostrar anuncios relevantes."
      ...
      {hasConsented && !showBanner && !showPreferences && (
        <button
          ...
          aria-label="Administrar preferencias de cookies"
